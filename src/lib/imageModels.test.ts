...
describe('imageModels', () => {
  ...
  it('getImageModelLabel 命中清单返回友好名，未命中回退原 id', () => {
    expect(getImageModelLabel('codex-gpt-image-2')).toBe('Codex GPT Image 2')
