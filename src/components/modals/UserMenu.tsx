...
import { deleteAvatar, logout, updateDisplayName, uploadAvatar, type AuthUser } from '../../lib/shared/auth'
...
import { CloseIcon, EditIcon, PhotoIcon, TrashIcon } from '../ui/icons'
