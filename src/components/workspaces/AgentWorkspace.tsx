...
import { TrashIcon, DownloadIcon, EditIcon, ChevronLeftIcon, ChevronRightIcon, FavoriteIcon, CloseIcon, CopyIcon, RefreshIcon, ArrowDownIcon, PhotoIcon } from '../ui/icons'
