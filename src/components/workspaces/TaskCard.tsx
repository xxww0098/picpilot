...
import { getParamDisplay, ActualValueBadge } from '../../lib/params/paramDisplay'
import { DEFAULT_IMAGES_MODEL } from '../../lib/shared/apiProfiles'
import { getImageModelLabel, isKnownImageModel } from '../../lib/image/imageModels'
import { isAgentTaskPromptPending } from '../../lib/task/taskPromptDisplay'
import { getTaskFailedImageSource, getTaskImageSource, getUpstreamModeLabel, hasMixedTaskImageSources } from '../../lib/task/taskSource'
import { getTaskStreamPreviewSummary } from '../../lib/ui/streamPreviews'
import { CodeIcon, RefreshIcon } from '../ui/icons'
